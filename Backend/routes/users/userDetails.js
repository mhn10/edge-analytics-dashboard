...
router.get('/', async (req, res) => {
	...
	data.map(obj => {
		if (obj.actionType === "classification") {
			...
			userModel.findOneAndUpdate({ $and: [{ email: username }, { classification: { name: obj.taskName } }] },
			...
			userModel.findOneAndUpdate({ $and: [{ email: username }, { regression: { name: obj.taskName } }] },
